...
setup_repo_sparse "core" "main" "core"
setup_repo_sparse "sse_engine" "main" "core"
setup_repo_sparse "mitigator" "main" "mitigator"
setup_repo_sparse "estimator" "main" "estimator"
setup_repo_sparse "combiner" "main" "combiner"
setup_repo_sparse "sse_runtime" "main" "sse_runtime"
...
if [ ! -d "device-gateway" ]; then
  git clone -b main https://github.com/oqtopus-team/device-gateway.git
fi
